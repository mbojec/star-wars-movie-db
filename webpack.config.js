...
module.exports = function(env) {
  ...
  const browsers = {
    dev: ['last 1 chrome version', 'last 1 firefox version', 'last 1 safari version'],
    prod: ['>0.2%', 'not dead', 'not op_mini all'],
  };
  ...
  if (isProd) {
    config.plugins.push(new MiniCSS({ filename: 'main.scss.[chunkhash].css' }));
  }
